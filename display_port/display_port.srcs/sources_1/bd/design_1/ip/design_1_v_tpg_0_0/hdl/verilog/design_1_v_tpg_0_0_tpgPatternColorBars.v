...
wire   [0:0] tmp_79_fu_186_p2;
wire   [0:0] tmp_87_fu_221_p2;
wire   [2:0] tmp_91_fu_245_p2;
wire   [63:0] tmp_92_fu_282_p1;
wire   [10:0] tmp_90_fu_233_p2;
wire   [10:0] tmp_88_fu_258_p2;
wire   [13:0] tmp_95_fu_166_p1;
wire   [13:0] tmp_s_fu_170_p2;
wire   [10:0] barWidth_V_fu_176_p4;
wire   [11:0] lhs_V_cast_fu_211_p1;
wire   [11:0] ret_V_fu_215_p2;
wire   [11:0] tmp_82_cast_fu_198_p1;
wire   [10:0] tmp_89_fu_227_p2;
wire   [0:0] tmp_96_fu_292_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_48)) begin
        if ((tmp_79_fu_186_p2 == 1'd1)) begin
            hBarSel_4_0 <= 3'd0;
        end else if (((tmp_87_fu_221_p2 == 1'd0) & (tmp_79_fu_186_p2 == 1'd0))) begin
            hBarSel_4_0 <= tmp_91_fu_245_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_48)) begin
        if ((tmp_79_fu_186_p2 == 1'd1)) begin
            xBar_V_0 <= 11'd0;
        end else if (((tmp_87_fu_221_p2 == 1'd1) & (tmp_79_fu_186_p2 == 1'd0))) begin
            xBar_V_0 <= tmp_88_fu_258_p2;
        end else if (((tmp_87_fu_221_p2 == 1'd0) & (tmp_79_fu_186_p2 == 1'd0))) begin
            xBar_V_0 <= tmp_90_fu_233_p2;
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_25)) begin
        if (((tmp_87_fu_221_p2 == 1'd0) & (tmp_79_fu_186_p2 == 1'd0))) begin
            ap_phi_mux_hBarSel_4_0_loc_phi_fu_157_p6 = tmp_91_fu_245_p2;
        end else if (((tmp_87_fu_221_p2 == 1'd1) & (tmp_79_fu_186_p2 == 1'd0))) begin
            ap_phi_mux_hBarSel_4_0_loc_phi_fu_157_p6 = hBarSel_4_0;
        end else if ((tmp_79_fu_186_p2 == 1'd1)) begin
...
assign Scalar_val_0_V_writ_fu_328_p3 = ((tmp_80_fu_192_p2[0:0] === 1'b1) ? tpgBarSelRgb_r_load_s_fu_320_p3 : tpgBarSelYuv_y_q0);

assign Scalar_val_1_V_writ_fu_350_p3 = ((sel_tmp4_reg_428[0:0] === 1'b1) ? tpgBarSelYuv_v_q0 : sel_tmp_fu_343_p3);

assign Scalar_val_2_V_writ_fu_365_p3 = ((tmp_80_fu_192_p2[0:0] === 1'b1) ? tpgBarSelRgb_b_load_s_fu_357_p3 : tpgBarSelYuv_v_q0);
...
assign sel_tmp1_fu_296_p2 = (tmp_80_fu_192_p2 ^ 1'd1);

assign sel_tmp2_fu_302_p2 = ((color != 8'd1) ? 1'b1 : 1'b0);

assign sel_tmp4_fu_314_p2 = (tmp_fu_308_p2 & sel_tmp2_fu_302_p2);

assign sel_tmp_fu_343_p3 = ((tmp_80_fu_192_p2[0:0] === 1'b1) ? tpgBarSelRgb_g_load_s_fu_335_p3 : tpgBarSelYuv_u_q0);

assign tmp_79_fu_186_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_80_fu_192_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

assign tmp_82_cast_fu_198_p1 = barWidth_V_fu_176_p4;

assign tmp_87_fu_221_p2 = ((ret_V_fu_215_p2 < tmp_82_cast_fu_198_p1) ? 1'b1 : 1'b0);

assign tmp_88_fu_258_p2 = (xBar_V_0 + 11'd1);

assign tmp_89_fu_227_p2 = (11'd1 - barWidth_V_fu_176_p4);

assign tmp_90_fu_233_p2 = (xBar_V_0 + tmp_89_fu_227_p2);

assign tmp_91_fu_245_p2 = (hBarSel_4_0 + 3'd1);

assign tmp_92_fu_282_p1 = ap_phi_mux_hBarSel_4_0_loc_phi_fu_157_p6;

assign tmp_95_fu_166_p1 = width[13:0];

assign tmp_96_fu_292_p1 = x[0:0];

assign tmp_fu_308_p2 = (tmp_96_fu_292_p1 & sel_tmp1_fu_296_p2);

assign tmp_s_fu_170_p2 = (14'd7 + tmp_95_fu_166_p1);

assign tpgBarSelRgb_b_address0 = tmp_92_fu_282_p1;

assign tpgBarSelRgb_b_load_s_fu_357_p3 = ((tpgBarSelRgb_b_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelRgb_g_address0 = tmp_92_fu_282_p1;

assign tpgBarSelRgb_g_load_s_fu_335_p3 = ((tpgBarSelRgb_g_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelRgb_r_address0 = tmp_92_fu_282_p1;

assign tpgBarSelRgb_r_load_s_fu_320_p3 = ((tpgBarSelRgb_r_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign tpgBarSelYuv_u_address0 = tmp_92_fu_282_p1;

assign tpgBarSelYuv_v_address0 = tmp_92_fu_282_p1;

assign tpgBarSelYuv_y_address0 = tmp_92_fu_282_p1;
