...
wire   [7:0] tmp_82_fu_58_p1;
wire   [6:0] tmp_83_fu_90_p4;
wire   [6:0] tmp_84_fu_106_p4;
...
assign icmp6_fu_116_p2 = ((tmp_84_fu_106_p4 != 7'd0) ? 1'b1 : 1'b0);

assign icmp_fu_100_p2 = ((tmp_83_fu_90_p4 == 7'd0) ? 1'b1 : 1'b0);
...
assign sel_tmp6_fu_202_p2 = (tmp_86_fu_198_p1 ^ 1'd1);
...
assign tmp_82_fu_58_p1 = x[7:0];

assign tmp_83_fu_90_p4 = {{color[7:1]}};

assign tmp_84_fu_106_p4 = {{color[7:1]}};

assign tmp_86_fu_198_p1 = x[0:0];

assign tmp_fu_168_p2 = (sel_tmp4_fu_154_p2 | sel_tmp2_fu_140_p2);

assign tmp_s_fu_62_p2 = ((tmp_82_fu_58_p1 == 8'd0) ? 1'b1 : 1'b0);
