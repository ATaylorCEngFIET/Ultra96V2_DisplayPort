...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_52)) begin
        if ((tmp_51_fu_388_p2 == 1'd1)) begin
            hBarSel_5_0 <= 3'd0;
        end else if (((tmp_73_fu_425_p2 == 1'd0) & (tmp_51_fu_388_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_52)) begin
        if ((tmp_45_fu_323_p2 == 1'd1)) begin
            vBarSel_1 <= 1'd0;
        end else if ((1'b1 == ap_condition_255)) begin
            vBarSel_1 <= tmp_50_fu_357_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_52)) begin
        if ((tmp_51_fu_388_p2 == 1'd1)) begin
            xCount_V_2_0 <= 10'd0;
        end else if (((tmp_51_fu_388_p2 == 1'd0) & (tmp_73_fu_425_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_45_fu_323_p2 == 1'd0) & (1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (or_cond_23_fu_351_p2 == 1'd1))) begin
        yCount_V_4 <= tmp_48_fu_370_p2;
    end else if ((((or_cond_23_fu_351_p2 == 1'd0) & (tmp_45_fu_323_p2 == 1'd0) & (1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_47_fu_345_p2 == 1'd1)) | ((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_fu_323_p2 == 1'd1)))) begin
        yCount_V_4 <= 6'd0;
    end
end
...
always @ (*) begin
    if (((or_cond_23_fu_351_p2 == 1'd0) & (tmp_45_fu_323_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_47_fu_345_p2 == 1'd1))) begin
        ap_phi_mux_vBarSel_3_loc_2_phi_fu_288_p8 = tmp_50_fu_357_p2;
    end else if ((((tmp_47_fu_345_p2 == 1'd0) & (or_cond_23_fu_351_p2 == 1'd0) & (tmp_45_fu_323_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_45_fu_323_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (or_cond_23_fu_351_p2 == 1'd1)))) begin
        ap_phi_mux_vBarSel_3_loc_2_phi_fu_288_p8 = vBarSel_1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_45_fu_323_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_condition_255 = ((or_cond_23_fu_351_p2 == 1'd0) & (tmp_45_fu_323_p2 == 1'd0) & (tmp_47_fu_345_p2 == 1'd1));
end
...
assign brmerge_fu_511_p2 = (tmp_57_cast_not_fu_505_p2 | tmp_56_fu_406_p2);
...
assign or_cond_23_fu_351_p2 = (tmp_47_fu_345_p2 & tmp_46_fu_339_p2);
...
assign sel_tmp3_fu_535_p2 = (tmp_53_fu_394_p2 & sel_tmp2_fu_529_p2);

assign sel_tmp4_fu_626_p3 = ((sel_tmp3_fu_535_p2[0:0] === 1'b1) ? DPtpgBarSelRgb_CEA_g_3_fu_597_p1 : sel_tmp1_fu_619_p3);

assign sel_tmp5_fu_541_p2 = (tmp_53_fu_394_p2 ^ 1'd1);

assign sel_tmp6_fu_547_p2 = (tmp_55_fu_400_p2 & sel_tmp5_fu_541_p2);

assign tmp_31_fu_517_p2 = (dpDynamicRange | color);

assign tmp_32_fu_523_p2 = ((tmp_31_fu_517_p2 == 8'd0) ? 1'b1 : 1'b0);

assign tmp_45_fu_323_p2 = ((tmp_s_fu_317_p2 == 16'd0) ? 1'b1 : 1'b0);

assign tmp_46_fu_339_p2 = ((yCount_V_4 != 6'd63) ? 1'b1 : 1'b0);

assign tmp_47_fu_345_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_48_fu_370_p2 = (yCount_V_4 + 6'd1);

assign tmp_50_fu_357_p2 = (vBarSel_1 ^ 1'd1);

assign tmp_51_fu_388_p2 = ((x == 16'd0) ? 1'b1 : 1'b0);

assign tmp_53_fu_394_p2 = ((color == 8'd0) ? 1'b1 : 1'b0);

assign tmp_55_fu_400_p2 = ((dpYUVCoef == 8'd0) ? 1'b1 : 1'b0);

assign tmp_56_fu_406_p2 = ((color == 8'd1) ? 1'b1 : 1'b0);

assign tmp_57_cast_not_fu_505_p2 = (tmp_81_fu_412_p1 ^ 1'd1);

assign tmp_59_fu_492_p3 = {{3'd0}, {tmp_cast_fu_488_p1}};
...
assign tmp_77_fu_500_p1 = tmp_59_fu_492_p3;

assign tmp_78_fu_553_p1 = DPtpgBarArray_q0;

assign tmp_81_fu_412_p1 = x[0:0];
